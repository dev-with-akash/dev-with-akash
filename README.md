...
![Activity Graph](https://github-readme-activity-graph.vercel.app/graph?username=dev-with-akash)
...
- Implemented JWT-based authentication with tenant isolation
- Designed secure login, signup, and token refresh mechanism
- Used MongoDB for scalable user and tenant management

### 💬 WhatsApp Notification Integration with LemonAI
- Integrated WhatsApp API with LemonAI to send automated notifications for different status updates
- Implemented webhook-based event handling for real-time communication
- Designed scalable message processing using Spring Boot and REST APIs
...
- Email: akyakash336@gmail.com
- LinkedIn: https://linkedin.com/in/akash71
